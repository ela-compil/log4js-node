...
, layoutMakers = {
  ...
  "customFunction": function(config) { return customFunctionLayout(config && config.func); },
...
function customFunctionLayout (func) {
  return function(loggingEvent) {
    loggingEvent = func(loggingEvent)

    if (typeof loggingEvent === 'string' || loggingEvent instanceof String)
      return loggingEvent;

    return basicLayout(loggingEvent);
  }
}
